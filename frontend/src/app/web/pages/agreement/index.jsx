...
export default function AgreementPage() {
	...
	return (
		...
		>
			<h2>
				Terms of Use of <span className="website_url">rsvphk.com</span>
			</h2>
			<p>
				Welcome to the <span className="website_name">RSVPHK</span> website (the
				"Website").
			</p>
			<p>
				<span className="website_name">RSVPHK</span> provides this Website and
				Services (located at <span className="website_url">rsvphk.com</span>) to
				you subject to the notices, terms, and conditions set forth in these
				terms (the "Terms of Use"). In addition, when you use any of our
				Services, you will be subject to the rules, guidelines, policies, terms,
				and conditions applicable to such service, and they are incorporated
				into this Terms of Use by this reference.
			</p>
			<p>
				These Terms of Use are effective as of{" "}
				<span className="date">
					{process.env.REACT_APP_TERMS_OF_USE_CHANGE_DATE}
				</span>
				.
			</p>
			<p>
			...
			<ul>
				...
				<li>
					...
					<span className="website_name">RSVPHK</span> may, at any time, and
					without prior notice, revoke and/or cancel your access if you fail to
			...
			<p>
				...
				are the sole property of <span className="website_name">RSVPHK</span>.
			</p>
			<p>
				...
				believe that any of the materials infringe on any third party's rights,
				please contact <span className="website_name">RSVPHK</span> immediately
			...
			<p>
				The Website is provided "AS IS." appfigures, its suppliers, officers,
				directors, employees, and agents exclude and disclaim all
				representations and warranties, express or implied, related to this
				Website or in connection with the Services. You exclude{" "}
				<span className="website_name">RSVPHK</span> from all liability for
				damages related to or arising out of the use of this Website.
			</p>
			<h3>Changes to these Terms of Use</h3>
			<p>
				<span className="website_name">RSVPHK</span> retains the right to, at
				any time, modify or discontinue, any or all parts of the Website without
				notice.
			</p>
			<p>
				Additionally, <span className="website_name">RSVPHK</span> reserves the
				right, in its sole discretion, to modify these Terms of Use at any time,
				effective by posting new terms on the Website with the date of
				modification. You are responsible for reading and understanding the
			...
			<p>
				...
				internal laws of the <span className="country">hk</span> without giving
				effect to any choice or conflict of law provision or rule.
			</p>
			<p>
				Any legal suit, action or proceeding arising out of, or related to,
				these Terms of Use or the Website shall be instituted exclusively in the
				federal courts of <span className="country">hk</span>.
			</p>
            <p style={{
                marginTop: 30,
                letterSpacing: 0.5
            }}>
                Look at our <Link to={routeURL.web.privacy_policy()} className="country">Privacy Policy</Link>.
			</p>
		</Container>
	);
}
